...
if __name__ == "__main__":
    ...
    # 绘制TSNE图
    plt.figure(figsize=(8, 6))
    sns.scatterplot(x=all_embedded[:, 0], y=all_embedded[:, 1], hue=all_labels, palette={'Generated Mol': '#8ECFC9', 'Source Mol': '#FFBE7A'}, alpha=0.8)
    ...
    # plt.show()
    plt.savefig('v3_gen_analy.png', dpi=1200, bbox_inches='tight')
